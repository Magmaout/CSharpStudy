            ...
            while (true) {
                ...
                switch (InputHelper.GetMenuPositiveInteger("\nВведите номер урока (0 - выход): ", "0-11")) {
                    case 0:
                        return;
                    case 1:
                        C_urok_01.Launcher.Run();
                        break;
                    case 2:
                        C_urok_02.Launcher.Run();
                        break;
                    case 3:
                        C_urok_03.Launcher.Run();
                        break;
                    case 4:
                        C_urok_04.Launcher.Run();
                        break;
                    case 5:
                        C_urok_05.Launcher.Run();
                        break;
                    case 6:
                        C_urok_06.Launcher.Run();
                        break;
                    case 7:
                        C_urok_07.Launcher.Run();
                        break;
                    case 8:
                        C_urok_08.Launcher.Run();
                        break;
                    case 9:
                        C_pract_01.Launcher.Run();
                        break;
                    case 10:
                        C_pract_02.Launcher.Run();
                        break;
                    case 11:
